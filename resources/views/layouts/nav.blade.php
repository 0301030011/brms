	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="example-navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				<li data-toggle="modal" data-target="#search-modal"><a><span class="glyphicon glyphicon-search"></span> 查找</a></li>
				<li><a href="{{ route('resources.index') }}"><span class="glyphicon glyphicon-book"></span> 图书列表</a></li>
